...
RSpec.describe Admin::InfoFetchers::LibraryThing::Api::WorkByTitleFetcher do
  describe '#fetch' do
    ...
    before do
      ...
      stub_request(:get, expected_url)
        .with(headers: { 'User-Agent' => Admin::InfoFetchers::LibraryThing::Api::BaseCaller::USER_AGENT })
