...
RSpec.describe Admin::WikiLinkSyncJob do
  describe '#perform' do
    ...
    let(:syncer) { instance_double(Admin::InfoFetchers::Wikipedia::WikiLinksSyncer) }

    before do
      allow(Admin::InfoFetchers::Wikipedia::WikiLinksSyncer).to receive(:new).and_return(syncer)
